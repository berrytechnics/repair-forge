...
import { RevenueByLocation } from "@/lib/api/reporting.api";
...
export default function RevenueByLocationChart({
  ...
  const chartData = useMemo(() => {
    ...
    const hoverColor = isDark ? "#818cf8" : "#6366f1";
      ...
      <div className="h-64 flex items-center justify-center bg-white dark:bg-gray-800 rounded-lg shadow">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            Loading revenue by location data...
          </p>
        </div>
      </div>
    );
      ...
      <div className="h-64 flex items-center justify-center bg-white dark:bg-gray-800 rounded-lg shadow">
        <div className="text-center">
          <p className="text-gray-500 dark:text-gray-400">
            No revenue by location data available
          </p>
        </div>
      </div>
    );
